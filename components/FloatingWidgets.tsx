  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[999999]">
      ...
      >
        ...
        >
          <Link 
            href="https://instagram.com/fluxgen.ai" 
            target="_blank"
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] flex items-center justify-center text-white shadow-[0_0_30px_rgba(253,29,29,0.4)] hover:scale-110 hover:rotate-6 transition-all duration-300"
          >
            <Instagram size={32} />
          </Link>
        </motion.div>
