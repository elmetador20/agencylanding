...
const FOUNDERS = [
  ...
  },
  {
    ...
    tagline: "Bridging engineering and intuitive design",
    accentWords: ["engineering", "design"],
    badge: 'Strategy · Design · Growth',
    bio: [
      "I bridge the gap between powerful engineering and intuitive design — turning ambitious roadmaps into shipped products that users actually love.",
      "As Creative Director & Founder, I steer product vision, brand identity, and go-to-market strategy. I ensure every pixel and every pipeline serves a purpose.",
      "My expertise spans UI/UX design systems, client strategy, and growth architecture. I work closely with engineering to ensure what we build is both technically excellent and market-ready.",
      "I've partnered on platforms across edtech, fintech, e-commerce, and health-tech — always with a bias toward speed, clarity, and scale.",
    ],
    domains: [
      { icon: <Layers size={14} />, label: 'UI/UX Design' },
      { icon: <Zap size={14} />, label: 'Product Strategy' },
      { icon: <Code2 size={14} />, label: 'Brand Identity' },
      { icon: <Cpu size={14} />, label: 'Growth Architecture' },
      { icon: <Shield size={14} />, label: 'Client Delivery' },
      { icon: <GitBranch size={14} />, label: 'Go-to-market' },
    ],
    stats: [
      { value: '10+', label: 'Projects Built' },
