...
export default function Footer() {
  return (
    <footer className="bg-brand-white pt-24 pb-12 border-t border-brand-border overflow-hidden relative">
      {/* Background Text */}
      <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 text-[15vw] font-black text-brand-black/5 whitespace-nowrap select-none pointer-events-none leading-none tracking-tighter uppercase">
        FluxGen
      </div>
        ...
        <div className="grid md:grid-cols-4 gap-16 mb-20 text-center md:text-left">
          <div className="md:col-span-1">
            <Link href="/" className="text-2xl font-black italic tracking-tighter flex justify-center md:justify-start items-center gap-2 mb-8 uppercase group">
              <div className="relative w-12 h-12 overflow-hidden rounded-xl bg-brand-black group-hover:scale-110 transition-all duration-500">
                <Image 
                  src="/fluxgen.jpeg" 
                  alt="FluxGen Logo" 
                  fill
